...
| <a name="input_security_group_ids"></a> [security\_group\_ids](#input\_security\_group\_ids) | The arn of the security group ids to associate with ecs service | `list(string)` | `[]`                         |    no    |
